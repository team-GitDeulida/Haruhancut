...
#Preview {
    GroupViewController(groupViewModel: GroupViewModel(userId: "testId", groupUsecase: GroupUsecase(repository: GroupRepository(firebaseAuthManager: FirebaseAuthManager.shared))))
}
